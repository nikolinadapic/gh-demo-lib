...
[![CI Build](https://github.com/nikolinadapic/gh-demo-lib/actions/workflows/ci.yml/badge.svg)](https://github.com/nikolinadapic/gh-demo-lib/actions/workflows/ci.yml)
...
repositories {
    ...
    maven {
        name = "GitHubPackages"
        url = uri("https://maven.pkg.github.com/nikolinadapic/gh-demo-lib")
        credentials {
